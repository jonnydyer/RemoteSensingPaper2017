...
CCD-based sensors still hold some performance advantages over CMOS sensors but the capability gap has narrowed almost completely and the manufacturing and read-out rate advantages offered by CMOS have led to wholesale adoption.
...
Resolution & \begin{tabular}[c]{@{}l@{}}Aperture Diameter\\ Altitude\\Pixel size\end{tabular} \\ \midrule
...
Both TDI pushbroom and step-and-stare allow for some form of stabilization or motion compensation which is required to obtain reasonable $SNR$ in high resolution systems.  Pushbroom is highlighted mostly for historical reference as it is impractical to use un-stabilized pushbroom collection in systems with $GSD$ much below 10m.
