...
where $W_{ct}$ is the cross-track swath width.

We will define a collection duty cycle metric that captures all of the impacts on collection capacity outside of the systme $ACR$ as:
...
For remote sensing systems constrained by sun and time-over-land, typically $\beta < 0.1$.  Note that later we will define a 
