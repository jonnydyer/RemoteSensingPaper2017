...
\textbf{This shows that $\eta_{ph} A \Omega$ is not only import, bus is in fact a fundamental imaging system capacity metric}.  
...
%TODO: Merge focal plane dimension section with the Q and pixel size section above.
