...
plt.plot(cmos_rolling['Pixel Size'], cmos_rolling['FWC']/1e3, 'rs', label='CMOS (Rolling)')
...
plt.semilogy(cmos_rolling['Pixel Size'], cmos_rolling['kpi1'], 'rs', label='CMOS (Rolling)')
plt.xlabel(r'$p_{px}$ (um)')
